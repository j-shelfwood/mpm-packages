...
function Manager.suggestViewsForMonitors(monitorCount)
    ...
    if hasMeBridge or hasRsBridge then
        for _, v in ipairs({"NetworkDashboard", "StorageGraph", "EnergyGraph", "EnergyStatus", "CraftingQueue", "CPUOverview", "CellHealth", "ItemGauge", "ItemBrowser", "FluidGauge", "FluidList", "ItemChanges", "CraftingCPU", "StorageBreakdown", "CraftableBrowser", "PatternBrowser", "DriveStatus"}) do
